...
export default async function UploadPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full overflow-hidden bg-gradient-to-br from-[#ffffff30] to-[#6938be57]">
      ...
      <div className="z-10 m-auto h-[85vh] w-[90%] overflow-hidden overflow-y-auto rounded-3xl border-[0.06rem] border-[#fffffff6] bg-white bg-opacity-10 shadow-[0_0_15px_rgba(0,0,0,0.05)] backdrop-blur-[0.2rem] backdrop-filter">
        <Navbar />
      </div>
    </div>
  );
